...
export const devlogPosts: DevlogPost[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "It's slowed us down more than once since then, and there are days it felt like overkill for a school project. But so far I still think it was the right call.",
    ],
  },
  {
  ...
  },
  {
    ...
    body: [
      ...
      "That one conversation is still the thing I remember most clearly out of everything we've discussed since.",
    ],
  },
  {
